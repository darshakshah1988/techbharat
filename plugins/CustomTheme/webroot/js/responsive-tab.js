...
// 		} );
	...
	fakewaffle.removeClasses=function(){
		 if($(window).width() > 991)
{
	$('.nav.nav-tabs.responsive,.tab-content.responsive').removeClass('d-none').removeClass('d-lg-flex');
}
else
{
	$('.nav.nav-tabs.responsive,.tab-content.responsive').addClass('d-none').addClass('d-lg-flex');
	}
		}
