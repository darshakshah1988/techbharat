...
namespace Testimonials\Test\Fixture;
...
class TestimonialsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 200, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'designation' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2020-07-27 18:21:40',
                'modified' => '2020-07-27 18:21:40',
            ],
        ];
        parent::init();
    }
