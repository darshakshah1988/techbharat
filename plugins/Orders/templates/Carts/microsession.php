                ...
                <table class="table table-bordered checkout-table">
                    ...
                    <tbody>
                        ...
                        foreach ($carts as $cart):                          
                            $totalAmount = $cart->micro_session->price - $cart->micro_session->discount_price;
                        ...
                        <tr>
                            ...
                            <td>
                                <?= $cart->has('course') ? $this->Html->link($cart->micro_session->title, ['controller' => 'Courses', 'action' => 'view', 'plugin' => 'Courses', $cart->micro_session->id]) : '' ?>
                                <p><?= $cart->micro_session->subject->title ?> | <?= $cart->micro_session->grading_type->title ?></p>
                            </td>
                            <td><h4><?= $this->Number->currency($cart->micro_session->price, 'INR') ?></h4></td>
                            <td>
                ...
                <div class="col-sm-12 text-center mt30 mb40">
                    ...
                    <?php if (!empty($carts->toArray())): ?>
                        <div class="col-sm-4 col-sm-offset-4 mt20 mb40">
                            <?= $this->Html->link('<span>CHECK</span>OUT', ['controller' => 'Orders', 'action' => 'microcheckout'], ['class' => 'cdm-right-buy-btn', 'escape' =>  false]) ?>
                        </div>
                    <?php endif; ?>
