...
<table class="table table-hover table-bordered">
                ...
                <tr>
                    <th><?= __('Start At') ?></th>
                    <td>
                        <?php if ($teacherSchedule->start_at) {
                                echo $teacherSchedule->start_at->format(\Cake\Core\Configure::read('Setting.ADMIN_DATE_TIME_FORMAT'));
                                }
                            ?>
                        </td>
                </tr>
                <tr>
                    <th><?= __('End At') ?></th>
                    <td>
                        <?php if ($teacherSchedule->end_at) {
                                echo $teacherSchedule->end_at->format(\Cake\Core\Configure::read('Setting.ADMIN_DATE_TIME_FORMAT'));
                                }
                            ?>
                        </td>
                </tr>
