...
<?php
                    ...
                    echo $this->Form->control('start_at', ['class' => 'form-control', 'placeholder' => __('Start At')]);
                    echo $this->Form->control('end_at', ['class' => 'form-control', 'placeholder' => __('End At')]);
                    echo $this->Form->control('status', ['class' => 'form-control', 'placeholder' => __('Status')]);
                    echo $this->Form->control('users._ids', ['options' => $users, 'class' => 'form-control multi']);
                ?>
            </div>
