...
<div class="content-top-sec">
        ...
        <small><?php echo empty($teacherSchedule->id) ? __('Here you can add New teacher schedule') : __('Here you can edit teacher schedule'); ?></small>
</div>
<?php $this->end(); ?>
...
<div class="col-12 col-sm-12 col-md-12">
        <div class="panel-default">
            <div class="panel-heading d-flex flex-wrap justify-content-between align-items-center">
                <h2><?= __(empty($teacherSchedule->id) ? 'Add Teacher Schedule' : 'Edit Teacher Schedule') ?></h2>
                <div class="d-flex flex-wrap">
                    <?php echo $this->Html->link("<i class='fa fa-fw fa-chevron-circle-left'></i> ".__('Back'), ['action' => 'index'], ['class' => 'btn btn-default btn-sm btn-flat mrg-r10', 'title' => __('Back'),'escape'=>false]); ?>
                </div>
            </div>

            <?= $this->Form->create($teacherSchedule, ['role' => 'form', 'enctype' => 'multipart/form-data', 'templates' => 'horizontal_form']) ?>
            <div class="panel-body">

            <?php
                    echo $this->Form->control('title', ['class' => 'form-control', 'placeholder' => __('Title')]);
                    echo $this->Form->control('start_at', ['type' => 'text','class' => 'form-control', 'required' => false, 'placeholder' => __('H:i:s'), 'value' => $teacherSchedule->start_at ? $teacherSchedule->start_at->format('H:i:s') : null]);
                    echo $this->Form->control('end_at', ['type' => 'text','class' => 'form-control', 'required' => false, 'placeholder' => __('H:i:s'), 'value' => $teacherSchedule->end_at ? $teacherSchedule->end_at->format('H:i:s') : null]);
