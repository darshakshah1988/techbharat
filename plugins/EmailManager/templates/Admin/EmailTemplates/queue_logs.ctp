...
<section class="content-header">
    <h1>
        <?= __('Pending Email logs') ?>  
        <small><?php echo __('Here you can manage the pending email logs'); ?></small>
    </h1>
        ...
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <div class="box-header">
                    <h3 class="box-title"><span class="caption-subject font-green bold uppercase">List <?= __('Pending Email logs') ?></span></h3>
