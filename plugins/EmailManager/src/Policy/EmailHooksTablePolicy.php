...
use EmailManager\Model\Entity\EmailHooksTable;
use Cake\ORM\Query;
use Authorization\Policy\Result;
use Authorization\Policy\BeforePolicyInterface;
/**
 * EmailHooksTable policy
 */
class EmailHooksTablePolicy implements BeforePolicyInterface
{
     ...
     * @return bool
     */
    public function canCreate(IdentityInterface $user, EmailHooksTable $emailHooksTable)
    {
    }
