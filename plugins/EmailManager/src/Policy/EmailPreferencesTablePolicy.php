...
use EmailManager\Model\Entity\EmailPreferences;
use Cake\ORM\Query;
use Authorization\Policy\Result;
use Authorization\Policy\BeforePolicyInterface;

/**
 * EmailPreferencesTable policy
 */
class EmailPreferencesTablePolicy implements BeforePolicyInterface
{
     ...
     * @return bool
     */
    public function canCreate(IdentityInterface $user, EmailPreferences $emailHooksTable)
    {
        if($user->is_supper_admin){
            return new Result(true);
        }
