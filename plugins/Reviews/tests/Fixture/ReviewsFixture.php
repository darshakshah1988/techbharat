...
namespace Reviews\Test\Fixture;
...
class ReviewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'photo' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'photo_dir' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'photo_size' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 1,
                'user_id' => '0f93a241-6ba1-43e1-8fe3-3a3802ab6cdb',
                'course_id' => 1,
                ...
                'status' => 1,
                'created' => '2020-12-09 19:55:40',
                'modified' => '2020-12-09 19:55:40',
            ],
        ];
        parent::init();
    }
