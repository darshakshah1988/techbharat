...
class PackagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'package_name' => ['type' => 'string', 'length' => 256, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        'package_title' => ['type' => 'string', 'length' => 256, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'package_title' => 'Lorem ipsum dolor sit amet',
                'grading_type_id' => 1,
                'board_id' => 1,
                'subject_id' => 1,
                ...
                'end_date' => '2021-06-27',
                'status' => 1,
                'created' => '2021-06-27 17:35:29',
                'modified' => '2021-06-27 17:35:29',
            ],
        ];
        parent::init();
    }
