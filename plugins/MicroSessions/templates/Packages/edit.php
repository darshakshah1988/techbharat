 ...
 */
$selected_sub=explode(",", $package->subject_id);
...
echo $this->Form->control('package_file', ['type' => 'file', 'class' => 'dropify', 'data-height' => 30, 'label' => 'File Upload' , 'data-default-file' => $nominate_file_path]);
            ?>
        </div>                      
                       <!--   <div class="col-md-12">
