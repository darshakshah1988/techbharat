                        ...
                        <table class="table table-bordered ssTable">
                            ...
                            <tbody>
                             <?php if (!empty($microSessions->toArray())):
                                ...
                                <tr>
                                    <td>
                                        <?= $this->Html->link($course->title, ['action' => 'microsessionDetails', $course->id], ['class' => 'namme']) ?>
                                    </td>
                                    <td>
                                        <p class="sstopic"><?= $course->subject->title ?><br>
                                            </p>
                                    </td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <?= $this->Html->link('View', ['controller' => 'MicroSessions', 'action' => 'microsessionDetails', $course->id], ['class' => 'btn btn-success']) ?>
