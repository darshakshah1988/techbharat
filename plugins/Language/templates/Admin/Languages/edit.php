...
<?php
                    ...
                    echo $this->Form->control('image_dir', ['class' => 'form-control', 'placeholder' => __('Image Dir')]);
                    echo $this->Form->control('image_size', ['class' => 'form-control', 'placeholder' => __('Image Size')]);
                    echo $this->Form->control('image_type', ['class' => 'form-control', 'placeholder' => __('Image Type')]);
