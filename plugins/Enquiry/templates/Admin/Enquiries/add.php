...
<div class="col-12 col-sm-12 col-md-12">
        <div class="panel-default">
            ...
            <?= $this->Form->create($enquiry, ['role' => 'form', 'enctype' => 'multipart/form-data', 'templates' => 'horizontal_form']) ?>
            <div class="panel-body">
                <?php
                    ...
                    //echo $this->Form->control('assigned_user_id', ['class' => 'form-control', 'placeholder' => __('Assigne To')]);
