 ...
 * GradingTypesFixture
 */
class GradingTypesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_indexes' => [
            'BY_GRADING_TYPE_ID' => ['type' => 'index', 'columns' => ['listing_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'position' => 1,
                'created' => '2020-09-26 06:59:18',
                'modified' => '2020-09-26 06:59:18',
            ],
        ];
        parent::init();
    }
