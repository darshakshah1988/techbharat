...
class CoursesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'section_name' => ['type' => 'string', 'length' => 250, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'code' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'BY_COURSES_ID' => ['type' => 'index', 'columns' => ['listing_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'position' => 1,
                'created' => '2020-08-04 17:28:31',
                'modified' => '2020-08-04 17:28:31',
            ],
        ];
        parent::init();
    }
