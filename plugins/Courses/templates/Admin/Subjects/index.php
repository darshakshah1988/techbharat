...
<div class="col-12 col-sm-12 col-md-12">
                ...
                <?= $this->Html->link("<i class=\"fa fa-trash\"></i>", ['action' => 'delete', $subject->id], ['class' => 'confirmDeleteBtn btn btn-block btn-danger btn-xs btn-flat', 'data-url'=> $this->Url->build(['action' => 'delete', $subject->id]), 'escape' => false,'data-toggle'=>'tooltip','alt'=>__('Delete subject'),'title'=>__('Delete subject')]) ?>
