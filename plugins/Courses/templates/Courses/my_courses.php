        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 TitleStripp">
                    ...
                    <div class="col-sm-3">
                        <?= $this->Html->link("Add A Course", ['action' => 'add'], ['class' => 'btn mybtn btn-block']) ?>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <tbody>
                             <?php if (!empty($courses->toArray())):
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <?= $this->Html->link('<i class="fa fa-plus"></i> Chapter', ['controller' => 'CourseChapters', 'action' => 'index', $course->id], ['class' => 'btn btn-success', 'escape' => false]) ?>

                                        <?= $this->Html->link('View', ['controller' => 'Courses', 'action' => 'view', $course->id], ['class' => 'btn btn-success']) ?>

                                        <?= $this->Html->link('Edit', ['controller' => 'Courses', 'action' => 'add', $course->id], ['class' => 'btn btn-primary']) ?>
