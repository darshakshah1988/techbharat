...
<div class="content-top-sec">
        ...
        <h1>
            <?= __('Manage Course Chapter') ?>
        </h1>
        <small><?php echo empty($courseChapter->id) ? __('Here you can add New course chapter') : __('Here you can edit course chapter'); ?></small>
</div>
<?php $this->end(); ?>

<div class="row courseChapters index content">
<div class="col-12 col-sm-12 col-md-12">
        <div class="panel-default">
            <div class="panel-heading d-flex flex-wrap justify-content-between align-items-center">
                <h2><?= __(empty($courseChapter->id) ? 'Add Course Chapter' : 'Edit Course Chapter') ?></h2>
                <div class="d-flex flex-wrap">
                    <?php echo $this->Html->link("<i class='fa fa-fw fa-chevron-circle-left'></i> ".__('Back'), ['action' => 'index'], ['class' => 'btn btn-default btn-sm btn-flat mrg-r10', 'title' => __('Back'),'escape'=>false]); ?>
                </div>
            </div>

            <?= $this->Form->create($courseChapter, ['role' => 'form', 'enctype' => 'multipart/form-data', 'templates' => 'horizontal_form']) ?>
            <div class="panel-body">

                <?php
                    echo $this->Form->control('course_id', ['class' => 'form-control', 'placeholder' => __('Course Id')]);
