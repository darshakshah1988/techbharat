 ...
 * Subjects Controller
 *
 * @property \Courses\Model\Table\SubjectsTable $Subjects
 * @method \Courses\Model\Entity\Subject[]|\Cake\Datasource\ResultSetInterface paginate($object = null, array $settings = [])
 */
class SubjectsController extends AppController
{
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Subjects->delete($subject)) {
            $result = ['status' => true, 'message' => __('The subject has been deleted.')];
        } else {
            $result = ['status' => false, 'message' => __('The subject could not be deleted. Please, try again.')];
        }
