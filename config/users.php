...
$config = [
    'Users' => [
        ...
        'table' => 'UserManager.Users',
        // Controller used to manage users plugin features & actions
        'controller' => 'UserManager.Users',
        // Password Hasher
        'passwordHasher' => '\Cake\Auth\DefaultPasswordHasher',
        'middlewareQueueLoader' => \UserManager\Middleware\MiddlewareQueueLoader::class,
        // token expiration, 1 hour
        'Token' => ['expiration' => 3600],
        'Email' => [
            'mailerClass' => \UserManager\Mailer\UserMailer::class,
    ...
    'Auth' => [
        ...
        'AuthorizationMiddleware' => [
            'unauthorizedHandler' => [
                'className' => 'UserManager.DefaultRedirect', 
            ]
        ],
    ...
    'OAuth' => [
        'providers' => [
            'facebook' => [
                ...
                'authParams' => ['scope' => ['public_profile', 'email', 'user_link']],
                'options' => [
                    'clientId' => '440112037050199',
                    'clientSecret' => '4f53ab1a1519c59c200a67cfaa09dd2f',
                    'class' => 'facebook-btn',
                    'label' => 'Login with',
            ...
            'google' => [
                ...
                'options' => [
                    'clientId' => '897169820719-oabcka0bn3il67el0stpccsf4j5mb6gs.apps.googleusercontent.com',
                    'clientSecret' => 'ASwUgvLP38FBq3cndobw9XsG',
                    'class' => 'google-btn',
                    'label' => 'Login with',
