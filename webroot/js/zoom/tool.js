var testTool = {
  ...
  getMeetingConfig: function (i) {
    return {
      ...
      pwd: document.getElementById("meeting_pwd_"+i).value,
      role: parseInt(document.getElementById("meeting_role_"+i).value, 10),
      email: testTool.b64EncodeUnicode(
        document.getElementById("meeting_email_"+i).value
      ),
      lang: document.getElementById("meeting_lang_"+i).value,
      signature: "",
      china: document.getElementById("meeting_china_"+i).value,
    };
  },
