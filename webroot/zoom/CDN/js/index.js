...
function websdkready() {
  ...
  var API_KEY = "NO2wt01WTtiryP92pLvu1Q";
   ...
   */
  var API_SECRET = "rxd2fZd7O7WcGeel8ZKQmsS6H7X0gwej46GQ";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/zoom/CDN/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
