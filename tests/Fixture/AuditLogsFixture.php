...
class AuditLogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'admin_user_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 1,
                'admin_user_id' => 1,
                'transaction' => 'b1552077-4974-4cc4-8d9e-34be73430f8f',
                'type' => 'Lorem',
                'primary_key' => 1,
